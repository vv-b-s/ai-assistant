...
If you feel any struggle, you can always look at the link:../code-old[code] directory, but keep in mind that learning through error
...
image::projet-structure.png[align=center]
